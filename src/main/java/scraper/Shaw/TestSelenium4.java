...
//        System.setProperty("webdriver.chrome.driver", "C:\\\\Users\\\\sachi\\\\Downloads\\\\chromedriver-win64 (1)\\\\chromedriver-win64\\\\chromedriver.exe");
        ...
        try {
            ...
            // Select the "Ultimate TV" tab using Actions
            WebElement ultimateTVTab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//li[@class='c-tab-slide__tab-list-item']//button[@id='ultimate-tv']")));
            Actions actions = new Actions(driver);
            actions.moveToElement(ultimateTVTab).click().perform(); // Use Actions to click on the element
            System.out.println("Ultimate TV option clicked");
