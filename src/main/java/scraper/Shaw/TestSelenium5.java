...
//        System.setProperty("webdriver.chrome.driver", "C:\\\\Users\\\\sachi\\\\Downloads\\\\chromedriver-win64 (1)\\\\chromedriver-win64\\\\chromedriver.exe");
        ...
        try {
            ...
            // Click on the "Favourite Bundles" tab using Actions
            WebElement favouriteBundlesTab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@id='favourite-bundles']")));
            Actions actions = new Actions(driver);
            actions.moveToElement(favouriteBundlesTab).click().perform();
            System.out.println("Favourite Bundles tab clicked");
            ...
            // Print all plan details
            System.out.println("Plan Details Found:");
                    ...
                    try {
                        ...
                        if (planName != null && !uniquePlanNames.contains(planName)) {
                            ...
                            PlanDetails planDetailsObject = new PlanDetails(
                                ...
                                "Favourite Bundles" // Plan sub-type
                            );
